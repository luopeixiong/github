        ...
        try:
            if selector_type == 'meta':
                ...
                if v:
                    ...
                    v = None
                return v
            elif "xpath_joinwith" in selector_type  :
                v = content.xpath(tag).extract()
                b = selector_type.replace("xpath_joinwith","")
                if v:
                    v = b.join(v)
                else:
                    v = None
                ...
                t = selector_type.replace('splitwith','')
                if hasattr(content,"url") and t:
                    return content.url.split(t)[tag]
                else:
                    raise AttributeError("split Must be a str and length")
        except Exception as e:
            print(e)
    @staticmethod
