...
class PrivateFundSpider(scrapy.Spider):
    ...
    def information_institution_parse(self, response):
        ...
        configs = [
            ...
            {'n': 'IT系统名称', 'En': 'IT_systeam', 't': 'xpath',
        ...
        for config in configs:
            ...
            if result[config['En']]:
                ...
                if config['dt'] == 'int':
                    result[config['En']] = int(result[config['En']])

        item['keys'] = ['org_No']
        item['db'] = 'fund_aoi_information'
        item['result'] = result
        yield item
    ...
    def business_valution_parse(self, response):
        ...
        configs = [
            ...
            {'n': '本服务备案时间', 'En': 'record_date', 't': 'xpath',
             'v': '//b[text()="本服务备案时间"]/parent::td/following-sibling::td[1]/text()', 'dt': ''},
            {'n': '服务部门/团队人员数量', 'En': 'team_emp_numbers', 't': 'xpath',
             'v': '//b[text()="服务部门/团队人员数量"]/parent::td/following-sibling::td[1]/text()', 'dt': ''},
            {'n': '含基金从业人员数量', 'En': 'fund_emp_numbers', 't': 'xpath',
             'v': '//b[text()="含基金从业人员数量"]/parent::td/following-sibling::td[1]/text()', 'dt': ''},
            {'n': '备注', 'En': 'remark', 't': 'xpath',
             'v': '//b[text()="备注"]/parent::td/following-sibling::td[1]/text()', 'dt': ''}
        ]
        for config in configs:
    ...
    def registration_parse(self, response):
        ...
        configs = [
            ...
            {'n': '服务部门/团队人员数量', 'En': 'team_emp_numbers', 't': 'xpath', 'v': '//b[text()="服务部门/团队人员数量"]/parent::td/following-sibling::td[1]/text()', 'dt': ''},
            {'n': '含基金从业人员数量', 'En': 'fund_emp_numbers', 't': 'xpath', 'v': '//b[text()="含基金从业人员数量"]/parent::td/following-sibling::td[1]/text()', 'dt': ''},
    ...
    def amacaccounting_firm_parse(self, response):
        ...
        configs = [
            {'n': '会计师事务所名称 ', 'En': 'name', 't': 'xpath', 'v': 'td[2]/text()', 'dt': ''},
    ...
    def amaclawparse(self, response):
        ...
        response1 = S2(text=res)
        configs = [
            {'n': '律师事务所名称 ', 'En': 'name', 't': 'xpath', 'v': 'td[2]/text()', 'dt': ''},
            {'n': '成立时间', 'En': 'setup_time', 't': 'xpath', 'v': 'td[3]/text()', 'dt': ''},
            {'n': '网址', 'En': 'website', 't': 'xpath', 'v': 'td[4]/text()|td[4]/a/text()', 'dt': ''},
            {'n': '联系地址', 'En': 'address', 't': 'xpath', 'v': 'td[5]/text()|td[5]/p/text()', 'dt': ''},
            {'n': '电话', 'En': 'tel_num', 't': 'xpath', 'v': 'td[6]/text()', 'dt': ''},
    ...
    def amacevaluationparse(self, response):
        ...
        response1 = S2(text=res)
        configs = [
            {'n': '基金销售机构名称', 'En': 'name', 't': 'xpath', 'v': 'td[2]/text()', 'dt': ''},
    ...
    def amacaccountparse(self, response):
        ...
        response1 = S2(text=res)
        configs = [
            {'n': '公司名称', 'En': 'company', 't': 'xpath', 'v': 'td[1]/text()|td[1]/pre/text()', 'dt': ''},
            {'n': '账户名称', 'En': 'name', 't': 'xpath', 'v': 'td[2]/text()|td[2]/pre/text()', 'dt': ''},
            {'n': '开户行', 'En': 'bank', 't': 'xpath', 'v': 'td[3]/text()|td[3]/a/text()|td[3]/pre/text()', 'dt': ''},
            {'n': '账号', 'En': 'accountnumber', 't': 'xpath', 'v': 'td[4]/text()|td[4]/p/text()|td[4]/pre/text()', 'dt': ''},
            ...
            {'n': '联系电话', 'En': 'tel_number', 't': 'xpath', 'v': 'td[7]/text()|td[7]/span/text()|td[7]/p/text()|td[7]/pre/text()', 'dt': ''},
        ]
        configs2 = [{'n': '账户名称', 'En': 'name', 't': 'xpath', 'v': 'td[1]/text()', 'dt': ''},
                    {'n': '开户行', 'En': 'bank', 't': 'xpath', 'v': 'td[2]/text()|td[2]/a/text()', 'dt': ''},
                    {'n': '账号', 'En': 'accountnumber', 't': 'xpath', 'v': 'td[3]/text()|td[3]/p/text()', 'dt': ''}]
        configs3 = [{'n': '账号', 'En': 'accountnumber', 't': 'xpath', 'v': 'td[1]/text()|td[1]/p/text()', 'dt': ''}]
        result = {}
    ...
    def amacpayparse(self, response):
        ...
        response1 = S2(text=res)
        configs = [
            {'n': '支付结算机构名称 ', 'En': 'name', 't': 'xpath', 'v': 'td[2]/text()', 'dt': ''},
            {'n': '首次在中国证监会备案时间', 'En': 'Approval_date', 't': 'xpath', 'v': 'td[3]/text()', 'dt': ''},
            {'n': '网址', 'En': 'website', 't': 'xpath', 'v': 'td[4]/text()|td[4]/a/text()', 'dt': ''},
            {'n': '联系地址', 'En': 'address', 't': 'xpath', 'v': 'td[5]/text()|td[5]/p/text()', 'dt': ''},
            {'n': '电话', 'En': 'tel_num', 't': 'xpath', 'v': 'td[6]/text()', 'dt': ''},
            {'n': '协会会员', 'En': 'member', 't': 'xpath', 'v': 'td[7]/text()', 'dt': ''},
    ...
    def amacSaleparse(self, response):
        ...
        configs = [
            {'n': '基金销售机构', 'En': 'name', 't': 'xpath', 'v': 'td[2]/text()', 'dt': ''},
            {'n': '业务核准时间', 'En': 'Approval_date', 't': 'xpath', 'v': 'td[3]/text()', 'dt': ''},
            {'n': '网址', 'En': 'website', 't': 'xpath', 'v': 'td[4]/text()|td[4]/a/text()', 'dt': ''},
            {'n': '联系地址', 'En': 'address', 't': 'xpath', 'v': 'td[5]/text()|td[5]/p/text()', 'dt': ''},
            {'n': '电话', 'En': 'tel_num', 't': 'xpath', 'v': 'td[6]/text()', 'dt': ''},
    ...
    def parse7(self, response):
        ...
        configs = [
            ...
            {'n': '员工人数', 'En': 'EmployeeCount', 't': 'json', 'v': 'PR_COUNT_PERSON', 'dt': ''},
            {'n': '基金从业资格', 'En': 'FundQualificationCount', 't': 'json', 'v': 'PTI1PERSON', 'dt': ''},
            {'n': '基金销售从业资格', 'En': 'SaleQualificationCount', 't': 'json', 'v': 'PTI2PERSON', 'dt': ''},
            {'n': '其他从业资格', 'En': 'OtherQualificationCount', 't': 'json', 'v': 'PTI3PERSON', 'dt': ''},
            {'n': 'PE/VC从业资格', 'En': 'PEQualificationCount', 't': 'json', 'v': 'PTI4PERSON', 'dt': ''},
            {'n': '合规风控负责人', 'En': 'RiskEmployeeCount', 't': 'json', 'v': 'PTI6PERSON', 'dt': ''},
            {'n': '基金投资顾问', 'En': 'FundInvestAdviserCount', 't': 'json', 'v': 'PTI7PERSON', 'dt': ''},
            {'n': '基金经理', 'En': 'FundManagerCount', 't': 'json', 'v': 'PTI8PERSON', 'dt': ''},
            {'n': '投资经理', 'En': 'InvestManagerCount', 't': 'json', 'v': 'PTI9PERSON', 'dt': ''},
            {'n': '投资总监', 'En': 'InvestDirectorCount', 't': 'json', 'v': 'PTI10PERSON', 'dt': ''},
            {'n': '机构ID', 'En': 'CorpRawID', 't': 'json', 'v': 'AOI_ID', 'dt': ''}
        ]
        for json_ in js['result']:
            ...
            yield scrapy.FormRequest(personurl,
                                     formdata=persondata,
                                     headers = self.headers1,
                                     meta = {'CropRawID':result['CorpRawID']},
    ...
    def personparse(self, response):
        ...
        js = json.loads(response.text)
        configs = [
            {'n': '机构ID', 'En': 'CropRowID', 't': 'meta', 'v': 'RPI_ID', 'dt': ''},
            {'n':'人员ID', 'En': 'Emp_id', 't': 'json', 'v': 'RPI_ID', 'dt': ''},
            {'n': '姓名', 'En': 'EmpFullName', 't': 'json', 'v': 'RPI_NAME', 'dt': ''},
            {'n': '机构全称', 'En': 'CropFullName', 't': 'json', 'v': 'AOI_NAME', 'dt': ''},
            {'n': '性别', 'En': 'Gender', 't': 'json', 'v': 'SCO_NAME', 'dt': ''},
            {'n': '学历', 'En': 'Education', 't': 'json', 'v': 'ECO_NAME', 'dt': ''},
            {'n': '证书类型', 'En': 'QualificatType', 't': 'json', 'v': 'CTI_NAME', 'dt': ''},
            {'n': '证书编号', 'En': 'QualificatNo', 't': 'json', 'v': 'CER_NUM', 'dt': ''},
            {'n': '证书发布日期', 'En': 'QualificatStartDate', 't': 'json', 'v': 'PPP_GET_DATE', 'dt': ''},
            {'n': '证书截止有效日期', 'En': 'QualificatEndDate', 't': 'json', 'v': 'PPP_END_DATE', 'dt': ''},
            {'n': '变更信息', 'En': 'ChangeInformationCount', 't': 'json', 'v': 'COUNTCER', 'dt': ''},
        ...
        for json_ in js:
            ...
            changedata = {'filter_EQS_RH#RPI_ID':str(result['Emp_id']),
                          'sqlkey':'registration',
                          'sqlval':'SEARCH_LIST_BY_PERSON'}
            yield scrapy.FormRequest(changeurl,
                                     formdata=changedata,
                                     headers = self.headers1,
                                     meta = {'Emp_id':result['Emp_id']},
    ...
    def changeparse(self, response):
        ...
        configs = [
            ...
            {'n': '人员ID', 'En': 'EmpID', 't': 'meta', 'v': 'COUNTCX', 'dt': ''}
        ]
        for json_ in js:
            for config in configs:
                if config['t'] == 'json':
...
#        print(js)
        ...
        print(self.totalPages1)
        result = {}
        configs = [
                    {"n":"成立规模","En":"setup_scale","t":"json","v":"CLGM","dt":""},
                    {"n":"成立时参与户数","En":"setup_Nums","t":"json","v":"CLSCYHS","dt":""},
...
#            print(item)
    ...
    def fund_pro_parse(self, response):#
        ...
        configs = [{"n":"成立时间","v":"//td[contains(text(),'成立时间:')]/following-sibling::td/text()","t":"xpath","En":"setup_date","dt":""},
                   ...
                   {"n":"月报应披露","v":"//td[contains(text(),'月报:')]/following-sibling::td/text()","t":"xpath","En":"month_should_reveal","dt":""},
                   {"n":"月报按时披露","v":"//td[contains(text(),'月报:')]/following-sibling::td/text()","t":"xpath","En":"month_reveal_intime","dt":""},
                   {"n":"月报未披露","v":"//td[contains(text(),'月报:')]/following-sibling::td/text()","t":"xpath","En":"month_None_reveal","dt":""},
                   {"n":"半年报应披露","v":"//td[contains(text(),'半年报:')]/following-sibling::td/text()","t":"xpath","En":"halfYear_should_reveal","dt":""},
                   {"n":"半年报按时披露","v":"//td[contains(text(),'半年报:')]/following-sibling::td/text()","t":"xpath","En":"halfYear_reveal_intime","dt":""},
                   {"n":"半年报未披露","v":"//td[contains(text(),'半年报:')]/following-sibling::td/text()","t":"xpath","En":"halfYear_None_reveal","dt":""},
                   {"n":"年报应披露","v":"//td[contains(text(),'年报:')]/following-sibling::td/text()","t":"xpath","En":"Year_should_reveal","dt":""},
                   {"n":"年报按时披露","v":"//td[contains(text(),'年报:')]/following-sibling::td/text()","t":"xpath","En":"Year_reveal_intime","dt":""},
                   {"n":"年报未披露","v":"//td[contains(text(),'年报:')]/following-sibling::td/text()","t":"xpath","En":"Year_None_reveal","dt":""},
                   {"n":"季报应披露","v":"//td[contains(text(),'季报:')]/following-sibling::td/text()","t":"xpath","En":"quarter_should_reveal","dt":""},
                   {"n":"季报按时披露","v":"//td[contains(text(),'季报:')]/following-sibling::td/text()","t":"xpath","En":"quarter_reveal_intime","dt":""},
                   {"n":"季报未披露","v":"//td[contains(text(),'季报:')]/following-sibling::td/text()","t":"xpath","En":"quarter_None_reveal","dt":""}
                   ]
        for config in configs:
            result[config['En']] = response.xpath(config['v']).extract_first()
            if result[config['En']]:
    ...
    def directfundparse(self, response):
        ...
        configs = [{'n':'产品名称','En':'pro_name','t':'xpath','v':'//td[contains(text(),"产品名称") and @class="td-title"]/following-sibling::td[@class="td-content"]/text()','dt':''},
                   {'n':'产品编码','En':'pro_code','t':'xpath','v':'//td[contains(text(),"产品编码") and @class="td-title"]/following-sibling::td[@class="td-content"]/text()','dt':''},
    ...
    def accountparse(self, response):
        ...
        configs = [
            ...
            {'n': '备案日期', 'En': 'recora_date', 't': 'xpath', 'v': '//td[contains(text(),"备案日期") and @class="td-title"]/following-sibling::td[@class="td-content"]/text()', 'dt': ''},
            {'n': '合同期限（月）', 'En': 'contract_period', 't': 'xpath', 'v': '//td[contains(text(),"合同期限（月）") and @class="td-title"]/following-sibling::td[@class="td-content"]/text()', 'dt': ''},
            {'n': '起始规模（亿元）', 'En': 'start_scale', 't': 'xpath', 'v': '//td[contains(text(),"起始规模（亿元）") and @class="td-title"]/following-sibling::td[@class="td-content"]/text()', 'dt': ''},
            {'n': '是否分级', 'En': 'classification', 't': 'xpath', 'v': '//td[contains(text(),"是否分级") and @class="td-title"]/following-sibling::td[@class="td-content"]/text()', 'dt': ''},
            {'n': '成立时投资者数量', 'En': 'investor_nums', 't': 'xpath', 'v': '//td[contains(text(),"成立时投资者数量") and @class="td-title"]/following-sibling::td[@class="td-content"]/text()', 'dt': ''},
            {'n': '非专项资产管理计划产品类型', 'En': 'type', 't': 'xpath', 'v': '//td[contains(text(),"非专项资产管理计划产品类型") and @class="td-title"]/following-sibling::td[@class="td-content"]/text()', 'dt': ''},
            {'n': 'url_id', 'En': 'url_id', 't': 'url_split', 'v': '', 'dt': ''}
        ]
        result = dict()
        for config in configs:
            if config['t'] == 'xpath':
                ...
                if result[config['En']]:
                    result[config['En']] = S.replace_invalid_char(result[config['En']])
        result['url_id'] = response.url.split("/")[-1][:-5]
        item['keys'] = []
        item['db'] = ''
        item['result'] = result
        yield item
    def qhparse(self, response):
        ...
        configs = [
            ...
            {'n': '投资类型', 'En': 'investment_type', 't': 'json', 'v': 'TZLX', 'dt': ''},
            {'n': '募集规模（万元）', 'En': 'collection_scale', 't': 'json', 'v': 'MPI_TOTAL_MONEY', 'dt': ''},
            {'n': '是否结构化', 'En': 'is_structured', 't': 'json', 'v': 'SFJGH', 'dt': ''},
            {'n': '初始委托人数量', 'En': 'start_client_nums', 't': 'json', 'v': 'MPI_PARTICIPATION_USER', 'dt': ''},
